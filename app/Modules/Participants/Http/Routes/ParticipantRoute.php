...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::post('events/{uuid}/participants/{id}/send-whatsapp-code', [ParticipantController::class, 'sendWhatsappCode'])->where('uuid', REGEX_UUID)->where('id', REGEX_ID);
    Route::post('events/{uuid}/participants/{id}/verify-whatsapp-code', [ParticipantController::class, 'verifyWhatsappCode'])->where('uuid', REGEX_UUID)->where('id', REGEX_ID);
